...
TCPclient::TCPclient(QObject *parent) : QObject(parent)
{
    ...
    connect(socket, QAbstractSocket::connected, [this]() { emit this->sig_connectStatus(STATUS_SUCCES); } );
    connect(socket, QAbstractSocket::errorOccurred, [this]() { emit this->sig_connectStatus(ERR_CONNECT_TO_HOST); });
    connect(socket, QAbstractSocket::disconnected, this, [this]() { emit this->sig_Disconnected(); });
    connect(socket, QAbstractSocket::readyRead, this, &TCPclient::ReadyReed);
}
